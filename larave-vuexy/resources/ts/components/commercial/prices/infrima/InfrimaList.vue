...
const getPrices = async () => {
  ...
  const data = await commercialPricesCommonsServices.get("inf", params.value);

  listPricesOptions.value = data.listPricesOptions;

  prices.value = await data.data.data;

  headers.value = await data.headers;

  pagination.value.total = await data.data.total;
